...
#include "Assemble_SchemaAction.generated.h"

USTRUCT()
struct FAssembleSchemaAction : public FEdGraphSchemaAction
{
	GENERATED_USTRUCT_BODY();

	FAssembleSchemaAction() : FEdGraphSchemaAction() {}
	FAssembleSchemaAction(FText InNodeCategory, FText InMenuDesc, FText InToolTip, const int32 InGrouping , UEdGraphNode* NodeTemplate , FName CategoryUtil)
