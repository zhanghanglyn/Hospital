...
#include "Action_SchemaAction.generated.h"

USTRUCT()
struct FActionSchemaAction : public FEdGraphSchemaAction
{
	GENERATED_USTRUCT_BODY();

	FActionSchemaAction() : FEdGraphSchemaAction() {}
	FActionSchemaAction(FText InNodeCategory, FText InMenuDesc, FText InToolTip, const int32 InGrouping , UEdGraphNode* NodeTemplate , FName CategoryUtil)
